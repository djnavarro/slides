...
splash <- paste(
  ' ',
  '<div class="jumbotron text-white bg-dark" style="padding-top: 5%; padding-bottom: 5%; background-size: cover">',
  '<h1 class="title" align="center" style="font-size:200%">Slide decks by Danielle Navarro</h1>',
  '<p align="center" style="font-size:150%"><a style="color:white" href="https://djnavarro.net">Homepage<a> <a style="color:white" href="https://art.djnavarro.net">Art</a> <a style="color:white" href="https://blog.djnavarro.net">Blog</a></p>',
  '</div>',
  '<br>',
  ' '
)
