...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://slides.djnavarro.net/installing-r/img/twitter-image.jpg",
    image_alt = "",
    og_type = "website",
...
background-image: url("img/rajan-alwan-y8SoSXbOimk-unsplash.jpg")
...
background-image: url("img/brett-jordan-WzzGU9dwMnU-unsplash.jpg")
background-size: cover
...
.pull-right-wide[
<br><br><br>
.larger[.embolden[Installing RStudio]]
]
...
- ...but you need to load the package every time
...
background-image: url("img/hani-bdran-twTS-ZY6MUE-unsplash.jpg")
background-size: cover
