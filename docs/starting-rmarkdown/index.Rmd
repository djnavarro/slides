...
meta() %>%
  ...
  meta_social(
    ...
    image = "https://slides.djnavarro.net/starting-rmarkdown/img/twitter-image.png",
    image_alt = "",
    og_type = "website",
...
- These slides: [djnavarro.net/starting-rmarkdown](https://djnavarro.net/starting-rmarkdown)
- YouTube videos: TBA
...
```{r, echo=FALSE}
knitr::include_graphics("img/word_document_surface.png", dpi = 200)
```
...
<br>
```{r, echo=FALSE}
knitr::include_graphics("img/html_document_surface.png", dpi = 150)
```
...
https://djnavarro.net/starting-rmarkdown
```
]
...
```{r, echo=FALSE}
knitr::include_graphics("img/example_professional_site.png", dpi = 300)
```
...
```{r, echo=FALSE}
knitr::include_graphics("img/example_visual_blog.png", dpi = 300)
```
...
```{r, echo=FALSE}
knitr::include_graphics("img/example_book.png", dpi = 150)
```
...
```{r, echo=FALSE}
knitr::include_graphics("img/example_papers.png", dpi = 200)
```
...
```{r, echo=FALSE}
knitr::include_graphics("img/example_slides.png", dpi = 150)
```
...
```{r, echo=FALSE}
knitr::include_graphics("img/example_resume.png", dpi = 200)
```
